    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TupleDesc)){
            ...
            if (todo.numFields() != n) {
                ...
                for (int i=0; i<n; ++i) {
                    boolean ifName = todo.TDItems[i].fieldName == null ?
                                TDItems[i].fieldName == null : todo.TDItems[i].fieldName.equals(todo.TDItems[i].fieldName);
                    boolean ifType = todo.TDItems[i].fieldType == TDItems[i].fieldType;
                    if(!ifName || !ifType){
                        return false;
                    }
                }
