...
public class HeapPage implements Page {
    ...
    private int getNumTuples() {
        ...
        int num = ((int) Math.floor((pageSize*8*1.0)/(td.getSize()*8+1.0)));
        return num;
    }
    ...
    public void deleteTuple(Tuple t) throws DbException {
        ...
        // set the tuple->slot as 0;
        markSlotUsed(slotId, false);
        // set the slot->tuple as null
        tuples[slotId] = null;
    ...
    public void insertTuple(Tuple t) throws DbException {
        ...
        if(getNumEmptySlots() == 0 || !(tupleDesc.equals(this.td))){
            throw new DbException("This page is full or the tupledesc is mismatching.");
        }
    ...
    public boolean isSlotUsed(int i) {
        // some code goes here
        // header is a byte array.
        // as a result, we should find the loc and the tmp;
        // to locate the place of the array.
        int loc = i/8;
        int offset = i%8;
        int tmp = 1<<offset;
